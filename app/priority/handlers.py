...
def get_priority_by_id(session: Session, priority_id: int) -> base_api_models.Priority:
    ...
    """
    item = db_models.Priority.find_by_id(session, priority_id)
...
def delete_priority_by_id(
    ...
    """
    db_models.Priority.delete_by_id(session, priority_id)
...
def add_priority(
    ...
    """
    db_models.Priority.create_from_data(session, payload.dict())
...
def update_priority(
    ...
    """
    db_models.Priority.update_by_id(session, priority_id, payload.dict())
